...
export const questionBeforeSpan = questionArr.questionBeforeSpan;
export const questionAfter = questionArr.questionAfter;
export const answerOptions = questionArr.answerOptions;
export const correctAnswer = questionArr.correctAnswer;
